...
# Modified Jonathan Teegarden 15 Jun 2020
...
@{
    ...
    Description          = 'To enable easier web automation through PowerShell, utilizing the Selenium Web Driver.'
    PowerShellVersion    = '5.1'
    ScriptsToProcess     = @(
        'SeleniumClasses.ps1'
    )
    RequiredAssemblies   = @(
        '.\assemblies\windows\WebDriver.dll',
        '.\assemblies\windows\WebDriver.Support.dll'
    )
    FunctionsToExport    = @(
        'Start-SeChrome',
        'Start-SeEdge',
